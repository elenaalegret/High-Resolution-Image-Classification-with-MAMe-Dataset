...
def train_perceptron():
    ...
    # 256 x 256
    model.add(Conv2D(32, (3, 3), padding='same', activation='relu', input_shape=input_shape, kernel_initializer=he_normal(), kernel_regularizer=regularizers.l1(1e-5),
    ...
    model.add(Conv2D(256, (3, 3), padding='same', activation='relu', kernel_regularizer=regularizers.l1(1e-5),
    ...
    model.add(Conv2D(512, (3, 3), padding='same', activation='relu', kernel_regularizer=regularizers.l1(1e-5),
    ...
    model.add(Dense(128, activation='relu', kernel_regularizer=regularizers.l1(1e-5),
